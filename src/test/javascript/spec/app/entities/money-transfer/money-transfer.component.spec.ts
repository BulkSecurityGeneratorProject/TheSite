...
import { MoneyTransferComponent } from 'app/entities/money-transfer/money-transfer.component';
...
describe('Component Tests', () => {
    describe('MoneyTransfer Management Component', () => {
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(MoneyTransferComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.moneyTransfers[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
